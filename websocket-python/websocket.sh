...
wget -O /usr/local/bin/ws-ovpn "https://raw.githubusercontent.com/asheeka/aws/main/lain2/ovpn.py"
...
wget -O /usr/local/bin/ws-dropbear "https://raw.githubusercontent.com/asheeka/aws/main/websocket-python/dropbear-ws.py"
...
wget -O /usr/local/bin/ws-stunnel "https://raw.githubusercontent.com/asheeka/aws/main/websocket-python/ws-stunnel.py"
...
wget -O /usr/local/bin/ws-openssh "https://raw.githubusercontent.com/asheeka/aws/main/lain2/edu-openssh.py"
